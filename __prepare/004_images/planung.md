...
- Images mit Dockerfiles selber bauen (am Beispiel docsify)
- Docsify-Image + Container bauen: Dockerfile, COPY, RUN, bestehendes docsify überführen: Dockerfile für Container erstellen + laufen lassen
...
* Endziel: Sie haben ein Image gebaut, welches mittels docsify Ihre Dokumentationsseite ausliefern kann.
...
2. Einführung Dockerfiles: Kurzes Beispiel zeigen
   ...
   3. Schüler bauen selber ein Dockerfile, welches ein Image für docsify baut
...
!!! Achtung: Schüler kamen letzte Lektion nicht annähernd so weit, wie geplant. Zeit in der ersten Lektion einplanen !!!
Ziel:

1. statische Webseite auf M293 läuft in eigenem httpd-Docker
2. statische Webseite hat die beiden Demo-Formulare der Abgabe integriert (formular/index.html, db-demo/index.html)
3. Monolith läuft parallel, die beiden Formulare funktionieren
...
|       | Schüler erhalten Anweisung, um docsify-Image mittels Dockerfile zu erstellen           |                               |
...
|       | Ziel: alle Schüler haben ein Dockerfile für docsify ertellt und daraus ein Container   |                               |
|       | zum Laufen gebracht                                                                    |                               |
